...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HOST; ?>/public/login.css">
...
<body>
    ...
    <div class="container">
        <div class="gauche">
            ...
            <div class="logo">
                <img src="<?php echo HOST; ?>/public/img/logo.png" alt="LOGO">
            </div>
        </div>
...
<script src = "<?php echo HOST; ?>/public/verifierLogin.js"></script>
