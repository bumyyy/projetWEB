...
document.addEventListener('DOMContentLoaded', function() {
    getDataApi('http://localhost/projetWEB/controller/apiUrl.php?demande=combox/sector', 'comboboxSecteur', 'secteur');
    getDataApi('http://localhost/projetWEB/controller/apiUrl.php?demande=combox/country', 'comboboxVille', 'ville');
});
